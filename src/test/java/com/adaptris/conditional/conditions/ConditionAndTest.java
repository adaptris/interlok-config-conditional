...
public class ConditionAndTest {
  ...
  @Mock
  private Condition mockConditionOne;

  @Mock
  private Condition mockConditionTwo;

  @Mock
  private Condition mockConditionThree;
  ...
  public void setUp() throws Exception {
    ...
    conditionAnd =
        new ConditionAnd().withConditions(mockConditionOne, mockConditionTwo, mockConditionThree);
